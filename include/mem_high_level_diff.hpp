...
class MemHighLevelDiff : DiffStrategy {

    public:
        MemHighLevelDiff(std::string file1, std::string file2);
    ...
    private:
        ...
        void compute_entities_changes();
        void compute_objects_updates();
        void compute_objects_adddel();
};